...
**Algorithm:**
1. Randomly select a minority class sample s well as its *k* nearest neighbors.
...
**G:** Our classifier ( $sens=$ 0.8889, $spec=$ 0.7007) with an optimized classification cutoff ( $c=$ 0.0699 ).<br><br>
